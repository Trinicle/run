...
Original Code - OSS sources remain Copyright (c) Microsoft Corporation, licensed under MIT. See [LICENSE.txt](LICENSE.txt) and [NOTICE.txt](NOTICE.txt).

Portions of this fork are Copyright (c) Hunter Freeland, also under MIT.

Third-party notices for bundled dependencies are in [ThirdPartyNotices.txt](ThirdPartyNotices.txt). Do not remove those files; MIT requires the notices to stay with the software.
...
See the upstream [How to Contribute](https://github.com/microsoft/vscode/wiki/How-to-Contribute) guide for compiling from source. Product identity lives in `product.json`.
