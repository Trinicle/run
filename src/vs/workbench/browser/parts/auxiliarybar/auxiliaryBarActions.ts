...
import { ActiveAuxiliaryContext, AuxiliaryBarMaximizedContext, AuxiliaryBarVisibleContext, SecondarySideBarVisibleContext } from '../../../common/contextkeys.js';
...
MenuRegistry.appendMenuItem(MenuId.AuxiliaryBarTitle, {
	...
	when: ContextKeyExpr.and(
		...
		// Chat view uses a compact title; hide the secondary-side-bar close control there.
		ActiveAuxiliaryContext.notEqualsTo('workbench.panel.chat'),
	)
});
	...
	constructor() {
		super({
			...
			menu: {
				...
				group: 'navigation',
				order: 1,
				when: ActiveAuxiliaryContext.notEqualsTo('workbench.panel.chat'),
			}
		});
	}
